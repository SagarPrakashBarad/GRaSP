...
class Latency:
    """Measure latency on device, using pytorch jit compilation or manually."""
    ...
    def forward(self, model: nn.Module, x: torch.Tensor, edge_index=None):
        """Update to handle both standard models and GCN models with edge_index."""
        if edge_index is not None:
            f = lambda: model(x, edge_index)
        else:
